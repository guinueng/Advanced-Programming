...
class right_triangle : public shape{ //Concrete class. : public involves on inheritance. ":" notates is_a relationship. -> triangle must make function on shape. to make polymorphic func.
